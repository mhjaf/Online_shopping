...
class Wseater extends StatefulWidget {
  @override
  _WseaterState createState() => _WseaterState();
}

ProductProvider productProvider;

class _WseaterState extends State<Wseater> {
  double height, width;
  ...
  Widget _Sweater() {
    return Column(
      children: <Widget>[
        Wrap(
          children: productProvider.getWsweatwerList.map((e) {
            return Expanded(
              child: Wrap(
                children: <Widget>[
                  GestureDetector(
